...
zFit = 2.407*cos(2.145*thetaFit-2.697)-3.594*thetaFit+1.885; % z坐标拟合公式（旋转为垂直之前）
...
xNewFit = 2.524*sin(2.143*thetaFit)+9.788;
yNewFit = 2.496*cos(2.143*thetaFit)+5.653;
zNewFit = 12.96*thetaFit-6.789;
