...
zFit = 5.34*cos(1.38*thetaFit-8.576)-6.674*thetaFit+3.496; % z坐标拟合公式（旋转为垂直之前）
...
xNewFit = 7.067*cos(1.38*thetaFit+5.037)+6.054;
yNewFit = 7.062*sin(1.38*thetaFit+1.896)+3.495;
